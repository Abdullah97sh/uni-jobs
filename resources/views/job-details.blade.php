            ...
            <div class="row align-items-center mb-5">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <span class="m-2"><span class="icon-room mr-2"></span>{{ $job->company_city }}</span>
                                <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-primary">Part
                                        Time</span></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-6">
                          @if ($saved)
                          <a disabled class="btn btn-block btn-light btn-md"><span
                            class="icon-heart-o mr-2 text-danger"></span>Saved</a>
                        @else
                          <a href="/save-job/{{ $job->id }}" class="btn btn-block btn-light btn-md"><span
                ...
                <div class="col-lg-4">
                    <div class="bg-light p-3 border rounded mb-4">
                        ...
                        <ul class="list-unstyled pl-3 mb-0">
                            ...
                            <li class="mb-2"><strong class="text-black">Employment Status: </strong> Part-time</li>
                            <li class="mb-2"><strong class="text-black">Email: </strong>{{ $job->company_email }}</li>
                            <li class="mb-2"><strong class="text-black">Job Location:</strong> {{ $job->company_city }}
                            </li>
                            <li class="mb-2"><strong class="text-black">Category:</strong> {{ $job->job_category }}</li>
                            <li class="mb-2"><strong class="text-black">Hours: </strong>{{ $job->job_hours }}</li>
                        </ul>
                    </div>
